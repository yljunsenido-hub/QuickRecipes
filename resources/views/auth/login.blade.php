<x-guest-layout>
    ...
    <!-- Left Section -->
            <div class="w-full md:w-1/2 mb-8 md:mb-0 md:pr-6 text-white">
                <h1 class="text-4xl font-bold mb-4 text-orange-500">Welcome Back</h1>
                <p class="mb-2">Welcome Back to QuickRecipes! Who said quick meals can’t be amazing? Let’s get cooking!</p>
            ...
            <div class="w-full md:w-1/2 bg-white/20 p-6 rounded-lg">
                <h2 class="text-center text-4xl font-semibold text-white mb-2 ">Sign in</h2>
